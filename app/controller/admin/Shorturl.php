...
class Shorturl
{
    ...
    public function edit(Request $request)
    {
        ...
        Db::name('shorturl')->where('id', $id)->update(['remark' => $remark]);
    ...
    public function delete(Request $request)
    {
        ...
        Db::name('shorturl')->where('id', $id)->delete();
    ...
    public function channelList(Request $request)
    {
        ...
        $list = Db::name('shorturl_channel')->order('sort')->select();
    ...
    public function channelAdd(Request $request)
    {
        ...
        $id = Db::name('shorturl_channel')->insertGetId($data);
    ...
    public function channelEdit(Request $request)
    {
        ...
        Db::name('shorturl_channel')->where('id', (int)$data['id'])->update($data);
    ...
    public function channelDelete(Request $request)
    {
        ...
        Db::name('shorturl_channel')->where('id', $id)->delete();
        return json(['code' => 0, 'message' => '删除成功']);
    }
}